...
def get_fermi_velocity(eigenvalues,kvec,cell):
    recip_cell = get_recip_cell(cell)
...
if __name__=="__main__":
    ...
    for j,t in enumerate(twist_angles):
        ...
        plot_bands(evals_mean,evals_std,kdat,efermi=None,colors='black',title='',label="",linestyle="solid",erange=erange[j],figname="figures/band_structures/band_structure_"+energy_model+"_"+tb_model+"_"+uq_type+"_t_"+str(t)+".jpg")
    ...
    plt.savefig("figures/band_structures/fermi_velocities_"+energy_model+"_"+tb_model+"_"+uq_type+"_t_"+str(t)+".jpg")
    plt.clf()
