...
Classical_energy_interlayer_bounds = np.array([[1,10],[0,1000],[0,1000],[-1000,0],[-1000,1000],[1e-2,100],[1e-2,100],[1e-4,1000]])
...
Classical_energy_intralayer_bounds = np.array([[1e-5,  1e6],[ 1e-5,  1e2],[-1,  1],
...
MK_bounds = np.array([[-5, -1.e-5], [ 1e-5,  5], [ 1e-5,  5]])
...
TETB_energy_interlayer_popov_bounds = np.array([[1e-4,10],[-10000,10000],[-10000,10000],[-10000,10000],[-10000,10000],[1e-4,10],[-1000,1000],[-1000,1000],[-1000,1000]])
...
interlayer_LETB_bounds = np.array([[-1.e2,  1.e2],[ 1.e-5,  1e2],[ 1.e-5,  100],[-1e1,  1e1],[ 1.e-5,  1e2],
                                    [ 1.e-5,  1e2],[-1e2,  -1e-6],[ 1.e-5,  1e2],[ 1.e-5,  1e2],[ 1e-5,  1e2]])
...
intralayer_LETB_NN_val_2_bounds = np.array([[-10,10],[-10,10],[-10,10],[-10,10]])
...
intralayer_LETB_NN_val_3_bounds = np.array([[-10,10],[-10,10],[-10,10],[-10,10]])
