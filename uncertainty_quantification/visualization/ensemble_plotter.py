...
if __name__=="__main__":
    ...
    model_names = ["Classical_energy_interlayer","Classical_energy_intralayer",
    ...
    model_names = ["MLP_SK_15_1","MLP_SK_10_1","MLP_SK_5_1","MLP_SK_20_1","MLP_SK_15_2","MLP_SK_10_2","MLP_SK_5_2"]
    ...
    uq_types = ["mcmc"] #,"cv"] 
    ensemble_suffix = ["ensemble_T","SubSamp_ensemble_p"]
            ...
            for uq_ind,uqt in enumerate(uq_types):
                ...
                for temp_ind,Temperature_weight in enumerate(uq_param_array[uq_ind]):
                    ...
                    if not os.path.exists(filename):
                        mae[temp_ind] = None
                        average_cost[temp_ind] = None
                        std_cost[temp_ind] = None
                        ks_metric[temp_ind] = None
                        continue
                ...
                print("Minimum KS Value = ",np.min(np.abs(ks_metric)))
